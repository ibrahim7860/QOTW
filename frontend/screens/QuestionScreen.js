        ...
        axios
            ...
            .then(async (response) => {
                ...
                for (let friend of friends) {
                    const friendUserID = friend.user_2_id !== globalUserId ? friend.user_2_id : friend.user_1_id;
                    await sendNotification(friendUserID, "New response!", globalUserId + " has responded to the question of the week!");
                }
            })
            .catch((error) => {
